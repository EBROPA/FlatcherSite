...
const sections = [
  {
    ...
    content: [
      ...
      "1.2. Оператор / «Мы» / «Нас» — Индивидуальный предприниматель Беляев Дмитрий Алексеевич, ИНН 540362531499, ОГРН 325784700102583, адрес: 191124, Санкт-Петербург г, Красного Текстильщика ул, д 10-12 лит.О. Контакты: info@flatcher.su. Вопросы по обработке ПДн — privacy@flatcher.su.",
  ...
  },
  {
    ...
    title: "16. Контакты",
    content: [
      "16.1. Оператор: ИП Беляев Дмитрий Алексеевич Адрес: 191124, Санкт-Петербург г, Красного Текстильщика ул, д 10-12 лит.О E-mail (общие вопросы): info@flatcher.su E-mail (вопросы по ПДн / отвод согласий): privacy@flatcher.su"
    ],
  },
];
