...
const introContent = [
  "Настоящее Пользовательское соглашение (далее — «Соглашение») является офертой (публичной офертой) Индивидуального предпринимателя Беляев Дмитрий Алексеевич (далее — «Компания», «Оператор») любому физическому лицу — пользователю сайта https://flatcher.su (далее — «Пользователь», «Сайт»). Принятием Соглашения считается начало использования Сайта Пользователем в любой форме (просмотр страниц, отправка форм, заказ обратного звонка и т.п.).",
...
const sections = [
  {
    ...
    content: [
      ...
      "1.2. Компания / Оператор — ИП Беляев Дмитрий Алексеевич, ИНН: 540362531499, ОГРН: 325784700102583, адрес: 191124, Санкт-Петербург г, Красного Текстильщика ул, д 10-12 лит.О, e-mail: info@flatcher.su.",
  ...
  },
  {
    ...
    content: [
      ...
      "15.2. Контактная информация Оператора: info@flatcher.su; адрес: 191124, Санкт-Петербург г, Красного Текстильщика ул, д 10-12 лит.О."
    ],
  },
];
