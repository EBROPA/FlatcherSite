...
const sections = [
  {
    ...
    content: [
      "1.1. Настоящее Согласие на обработку персональных данных (далее – «Согласие») регулирует порядок обработки персональных данных субъектов персональных данных (далее – «Субъект») Индивидуальным предпринимателем Гусевым Никитой Олеговичем (ИНН: 540362531499, ОГРНИП: 325784700102583, адрес: 191124, Санкт-Петербург г, Красного Текстильщика ул, д 10-12 лит.О, e-mail: info@flatcher.su) (далее – «Оператор»).",
